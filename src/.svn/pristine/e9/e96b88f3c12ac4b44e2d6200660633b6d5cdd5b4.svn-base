 ...
 * @NotThreadSafe
 */
public class AdvancedBZip2CompressorInputStream extends CompressorInputStream {
     ...
     */
    private AdvancedBZip2CompressorInputStream.Data data;

    /**
     * Constructs a new BZip2CompressorInputStream which decompresses bytes read
     ...
     */
    public AdvancedBZip2CompressorInputStream(final InputStream in) throws IOException {
        super();
...
//            System.out.println(this.in.available());
    ...
    private final class Data extends Object {
    ...
    public void setBlockSize100k(int blockSize100k) {
