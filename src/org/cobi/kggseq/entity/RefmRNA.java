...
//                    System.out.println(chr+":"+oldStartPos+":"+ref);
     ...
     * 
     */
    public GeneFeature calculateAminoAcidChange(int relativeCodingStartPosInRef, char ref, char alt, int absPos, int pos2CondingEnd, String geneSym, byte[] errorCode) {
        int shiftBpDel = 0;
