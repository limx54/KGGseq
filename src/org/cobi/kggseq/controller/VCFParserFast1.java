 ...
 *
 */
public class VCFParserFast1 implements Constants {

    private static final Logger LOG = Logger.getLogger(VCFParserFast1.class);
    ...
    public Genome readVariantGtyFilterOnly(String tempFolder, int threadNum, Genome orgGenome, String vAFile,
            ...
            int minSecondPL, double minBestGP, boolean needProgressionIndicator, boolean needGty, boolean needReadsInfor, boolean needGtyQual, boolean noGtyVCF,
        ...
        if (vAFile.contains("_CHROM_")) {
            for (int i = 0; i < STAND_CHROM_NAMES.length; i++) {
                ...
                acceptVarNum += readVariantsInFileOnlyFastToken(threadNum, orgGenome, dataFile, genome, avgSeqQualityThrehsold, minMappingQual, maxStrandBias, maxFisherStrandBias, maxAlleleNum, gtyQualityThrehsold, minSeqDepth,
                        ...
                        needGty, needReadsInfor, needGtyQual, noGtyVCF, subjectList, effectIndivID, caseSetID, controlSetID, regionsIn, regionsOut);
            ...
            for (int i = 0; i < chroms.length; i++) {
                ...
                acceptVarNum += readVariantsInFileOnlyFastToken(threadNum, orgGenome, dataFile, genome, avgSeqQualityThrehsold, minMappingQual, maxStrandBias, maxFisherStrandBias, maxAlleleNum, gtyQualityThrehsold, minSeqDepth,
                        ...
                        needProgressionIndicator, needGty, needReadsInfor, needGtyQual, noGtyVCF, subjectList, effectIndivID, caseSetID, controlSetID, regionsIn, regionsOut);
            }
        } else {
    ...
    public int readVariantsInFileOnlyFastToken(int threadNum, Genome orgGenome, File dataFile, final Genome targGenome,
            ...
            boolean needGty, boolean needReadInfo, boolean needGtyQual, boolean noGtyVCF, final List<Individual> masterSubjectList, IntArrayList effectIndivID,
...
//System.out.println(currentLine); 
            ...
            VCFParseTaskFast1[] parsTaskArray = new VCFParseTaskFast1[maxThreadNum];
