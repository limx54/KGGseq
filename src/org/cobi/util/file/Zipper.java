...
public class Zipper {
    ...
    public void createFileGZIP(String filePathAndName, String zipFilePathAndName) throws Exception {
        //compress all files and folders under filePathAndName
        File baseFolder = new File(filePathAndName);
        if (baseFolder.isDirectory()) {
            System.err.println("Error! " + filePathAndName + " is a folder!");
            return;
        }
        ...
        BufferedOutputStream out = new BufferedOutputStream(new GZIPOutputStream(new FileOutputStream(zipFilePathAndName)));
    ...
    public void extractZip(String zipFilePathAndName, String baseDir) throws Exception {
        ...
        while (zList.hasMoreElements()) {
            ...
            //  GlobalManager.mainView.insertBriefRunningInfor("Extracted: " + ze.getName(), true);
            //  GlobalManager.addInforLog("Extracted: " + ze.getName());
        }
        zfile.close();
    }
